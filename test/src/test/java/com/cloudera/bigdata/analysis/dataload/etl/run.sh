...
echo "put 'sourcetable','row1','cf:col13','¿Ó¥Û≥¨" | hbase shell
...
java -Djava.library.path=/usr/lib/hadoop/lib/native/Linux-amd64-64 -cp $CLASSPATH org.junit.runner.JUnitCore com.intel.etl.GeneralETLToolTest
