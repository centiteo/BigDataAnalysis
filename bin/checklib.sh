...
HADOOP_JAR=`ls $currentpath/../lib | grep hadoop-core- | grep Intel.jar`
HBASE_JAR=`ls $currentpath/../lib | grep hbase- | grep Intel.jar`
ZOOKEEPER_JAR=`ls $currentpath/../lib | grep zookeeper- | grep Intel.jar`
