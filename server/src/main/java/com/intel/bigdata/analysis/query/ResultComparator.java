 ...
 * {@link com.intel.bigdata.analysis.dataload.query.Query} object specified.
 * This is a generic comparator based on reflection. it can sort by any field of
 * record object. the only thing should be careful, the order-by qualifier must
 * keep the same name with field!
 */
