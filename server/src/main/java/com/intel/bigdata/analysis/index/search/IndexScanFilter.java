 ...
 * {@link com.intel.its.server.search.IndexBasedSearchStrategy} will use this
 * filter to filter each row, make sure whether each index entry should include
 * or exclude from final result set.
 */
