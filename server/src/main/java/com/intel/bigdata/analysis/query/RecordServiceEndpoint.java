...
import com.intel.bigdata.analysis.index.protobuf.generated.RecordServiceProto.RecordService;
import com.intel.bigdata.analysis.index.search.SearchStrategy;
import com.intel.bigdata.analysis.index.search.SearchStrategyDecider;
...
public class RecordServiceEndpoint extends RecordService implements
  ...
  // public void refreshIndexMap(String tableName);
}
