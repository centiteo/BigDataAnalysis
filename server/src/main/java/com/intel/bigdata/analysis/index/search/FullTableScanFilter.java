...
import com.intel.bigdata.analysis.index.protobuf.generated.FilterProto;
 ...
 * {@link com.intel.its.core.query.Query} object, the filter rule is whether
 * given row match conditions of query object.
 * 
 * The filter also need the resolved
 * {@link com.intel.its.server.search.IndexRangeSet} to verify whether current
 * row match condition!!
 */
