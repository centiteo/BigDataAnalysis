...
import com.intel.bigdata.analysis.index.formatter.IndexFieldValueFormatter;
import com.intel.bigdata.analysis.index.util.ByteArrayUtils;
import com.intel.bigdata.analysis.query.AndCondition;
import com.intel.bigdata.analysis.query.Condition;
import com.intel.bigdata.analysis.query.InvalidQueryException;
import com.intel.bigdata.analysis.query.Operator;
import com.intel.bigdata.analysis.query.OrCondition;
import com.intel.bigdata.analysis.query.Query;
import com.intel.bigdata.analysis.query.SimpleCondition;

/**
 * When coprocessor receiving a query request, it uses this class to decide what
 * kind of {@link com.intel.its.server.search.SearchStrategy} should apply.
 * There are two kinds of search strategy:
 * {@link com.intel.its.server.search.IndexBasedSearchStrategy} and
 ...
 * </p>
 * 
 * @see com.intel.its.server.coprocessor.CaptureRecordCoprocessor#query(com.intel.its.core.query.Query)
 */
