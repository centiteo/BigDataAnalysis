...
The main entry is datagen/src/java/main/com/intel/bigdata/analysis/datagen/GeneratorDriver.java. 
...
Then, you can invoke com.intel.bigdata.analysis.datagen.GeneratorDriver, it has the following options, (*) is required:
 ...
 *UDF              <column>
			         ...
			         <udfName>com.intel.bigdata.analysis.custom.datagen.ServiceTypeGenerator</udfName>
