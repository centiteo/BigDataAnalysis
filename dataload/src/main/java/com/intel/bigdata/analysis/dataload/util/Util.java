...
import com.intel.bigdata.analysis.dataload.source.DataSource;
import com.intel.bigdata.analysis.dataload.source.FileParser;
import com.intel.bigdata.analysis.dataload.transform.ExtensibleHBaseRowConverter;
...
public class Util {
   ...
   * @return
   */
  public static byte[][] genSplitKeys(String prefixesStr, int splitSize) throws Exception {
    if (prefixesStr == null) {
      prefixesStr = "";
    }
