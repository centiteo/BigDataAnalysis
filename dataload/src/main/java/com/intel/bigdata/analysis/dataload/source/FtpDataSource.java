...
import com.intel.bigdata.analysis.dataload.io.FtpFileObject;

//import com.intel.hbase.client.dataload.source.DataSource.FileHandleStatus;
  ...
  public Class<? extends FileObject> getFileObjectClass() {
    try {
      return (Class<? extends FileObject>) Class
          .forName("com.intel.bigdata.analysis.dataload.io.FtpFileObject");
