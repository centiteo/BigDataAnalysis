package java.com.intel.bigdata.analysis.hdfs.client;
...
public class GZFileUtils {
  ...
  private static final String USAGE_STR = "com.intel.bigdata.analysis.dataload.util.GZFileUtils <inputGZDir> <hdfsDir> <hdfsGZSize> <workerThreads>";
